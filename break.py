...
try:
    ...
    # Locate the "02. Break" option within the status dropdown
    break_option = wait.until(
        EC.element_to_be_clickable((By.XPATH, "//select[@id='statusListCombo']/option[text()='02. Break']"))
    )
    print_element_info("Break option", break_option)

    # Click on the "02. Break" option
    break_option.click()
    ...
    print("Successfully changed status to '02. Break'")
