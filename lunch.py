...
try:
    ...
    # Locate the "03. Lunch" option within the status dropdown
    lunch_option = wait.until(
        EC.element_to_be_clickable((By.XPATH, "//select[@id='statusListCombo']/option[text()='03. Lunch']"))
    )
    print_element_info("Lunch option", lunch_option)

    # Click on the "03. Lunch" option
    lunch_option.click()
    ...
    print("Successfully changed status to '03. Lunch'")
